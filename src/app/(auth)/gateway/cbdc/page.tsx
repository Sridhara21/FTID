...
import { Coins, Activity, Network, ShieldCheck } from "lucide-react";

export default function PageComponent() {
  return (
    <div className="flex flex-col gap-6 animate-in fade-in duration-500">
      <div>
        <h1 className="text-2xl font-bold tracking-tight">CBDC Settlement Layer</h1>
        <p className="text-muted-foreground">
          Programmable fiat and atomic settlements.
        </p>
      </div>
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        <Card className="col-span-1 md:col-span-2 border-border/50 bg-secondary/10 flex flex-col justify-center items-center min-h-[300px] relative overflow-hidden group">
          ...
          <div className="z-10 text-center flex flex-col items-center">
            ...
            <h3 className="text-lg font-semibold">CBDC Settlement Layer Module</h3>
