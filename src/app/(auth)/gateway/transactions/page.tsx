...
<CardHeader>
<CardTitle className="text-white">Transactions Records</CardTitle>
<CardDescription className="text-slate-400">Tracking: Real-time settlements, Failures, Delays, High-value transfers</CardDescription>
</CardHeader>
<CardContent>
<AuditLedgerExplorer columns={["Real-time settlements","Failures","Delays","High-value transfers"]} />
</CardContent>
</Card>
</div>
