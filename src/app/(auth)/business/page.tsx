      ...
      <div className="max-w-7xl mx-auto p-6 relative z-10 space-y-6">
        ...
        <header className="flex flex-col md:flex-row md:items-end justify-between gap-4 border-b border-cyan-900/40 pb-6">
          <div>
            ...
            <h1 className="text-3xl font-black text-white tracking-tight">Business Portal Core</h1>
            <p className="text-sm text-cyan-100/60 mt-2 max-w-2xl">
              Advanced observability module rendering real-time telemetry for: <span className="text-cyan-400 font-medium">operational trust score, compliance health, vendor reliability</span>.
            </p>
          </div>
        </header>
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <AIPulseIntelligence 
                ...
                primaryInsight="System detects active operations related to operational trust score."
                secondaryInsights={[
