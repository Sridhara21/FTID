  ...
  return (
    <div className="grid gap-6">
        ...
        <div className="p-4 bg-primary/5 border border-primary/20 rounded-lg flex items-center gap-3">
            ...
            <p className="text-[10px] font-bold uppercase tracking-widest text-primary/80 leading-relaxed">
                            ...
                            <Table>
                                ...
                                <TableBody>
                                    {governmentBalanceSheetDataFy2526.assets.map(asset => (
                                        <TableRow key={asset.name} className="h-12 hover:bg-secondary/10 border-b last:border-0">
                            ...
                            <Table>
                                ...
                                <TableBody>
                                    {governmentBalanceSheetDataFy2526.liabilities.map(liability => (
                                        <TableRow key={liability.name} className="h-12 hover:bg-secondary/10 border-b last:border-0">
