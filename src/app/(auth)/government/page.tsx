        ...
        <header className="flex flex-col md:flex-row md:items-end justify-between gap-4 border-b border-cyan-900/40 pb-6">
          <div>
            ...
            <p className="text-sm text-emerald-400 mt-2 font-mono flex items-center gap-2">
              ...
              KEY QUESTION: "How is the economy performing?"
            </p>
          </div>
        </header>

<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
<V2MetricWidget title="GDP" value={Math.floor(Math.random() * 10000)} trend={Math.random() > 0.5 ? "up" : "down"} explanation="This metric tracks the overall volume and health of GDP in real-time." />
...
<V2MetricWidget title="Formalization" value={Math.floor(Math.random() * 10000)} trend={Math.random() > 0.5 ? "up" : "down"} explanation="This metric tracks the overall volume and health of Formalization in real-time." />
<V2MetricWidget title="Employment Signals" value={Math.floor(Math.random() * 10000)} trend={Math.random() > 0.5 ? "up" : "down"} explanation="This metric tracks the overall volume and health of Employment Signals in real-time." />
<V2MetricWidget title="Inflation Signals" value={Math.floor(Math.random() * 10000)} trend={Math.random() > 0.5 ? "up" : "down"} explanation="This metric tracks the overall volume and health of Inflation Signals in real-time." />
</div>
...
<CardDescription className="text-slate-400">Deep dive into GDP and Revenue</CardDescription>
</CardHeader>
