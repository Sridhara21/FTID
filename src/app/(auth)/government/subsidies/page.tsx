        ...
        <header className="flex flex-col md:flex-row md:items-end justify-between gap-4 border-b border-cyan-900/40 pb-6">
          <div>
            ...
            <p className="text-sm text-emerald-400 mt-2 font-mono flex items-center gap-2">
              ...
              KEY QUESTION: "DBT and leakage tracking"
            </p>
          </div>
        </header>
...
<CardDescription className="text-slate-400">Tracking: Scheme performance, Leakage detection, Beneficiary analytics, Impact analytics</CardDescription>
</CardHeader>
<CardContent>
<AuditLedgerExplorer columns={["Scheme performance","Leakage detection","Beneficiary analytics","Impact analytics"]} />
</CardContent>
</Card>
</div>
