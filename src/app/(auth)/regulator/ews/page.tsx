        ...
        <header className="flex flex-col md:flex-row md:items-end justify-between gap-4 border-b border-cyan-900/40 pb-6">
          <div>
            ...
            <p className="text-sm text-emerald-400 mt-2 font-mono flex items-center gap-2">
              ...
              KEY QUESTION: "Detect future crises"
            </p>
          </div>
        </header>
...
<CardHeader>
<CardTitle className="text-white">Early Warning System Records</CardTitle>
<CardDescription className="text-slate-400">Tracking: Risk alerts, Institution alerts, Sector alerts, Escalation workflow</CardDescription>
</CardHeader>
<CardContent>
<AuditLedgerExplorer columns={["Risk alerts","Institution alerts","Sector alerts","Escalation workflow"]} />
</CardContent>
</Card>
</div>
