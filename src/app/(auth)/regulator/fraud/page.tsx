...
export default function RegulatorfraudPage() {
  return (
      ...
      <div className="max-w-7xl mx-auto p-6 relative z-10 space-y-6">
        ...
        <header className="flex flex-col md:flex-row md:items-end justify-between gap-4 border-b border-cyan-900/40 pb-6">
          <div>
            ...
            <h1 className="text-3xl font-black text-white tracking-tight">Fraud</h1>
            <p className="text-sm text-emerald-400 mt-2 font-mono flex items-center gap-2">
              <AlertCircle className="h-4 w-4" /> 
              KEY QUESTION: "National AML command center"
            </p>
          </div>
        </header>
...
<CardHeader>
<CardTitle className="text-white">Fraud Records</CardTitle>
<CardDescription className="text-slate-400">Tracking: Shell companies, Circular flows, Layering, Smurfing indicators</CardDescription>
</CardHeader>
<CardContent>
<AuditLedgerExplorer columns={["Shell companies","Circular flows","Layering","Smurfing indicators"]} />
</CardContent>
</Card>
</div>
