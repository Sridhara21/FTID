        ...
        <header className="flex flex-col md:flex-row md:items-end justify-between gap-4 border-b border-cyan-900/40 pb-6">
          <div>
            ...
            <p className="text-sm text-emerald-400 mt-2 font-mono flex items-center gap-2">
              ...
              KEY QUESTION: "Institutional fraud alerts"
            </p>
          </div>
        </header>
...
<CardDescription className="text-slate-400">Tracking: Mule Accounts, Suspicious Transactions, AML Alerts, Customer Risk Profiles</CardDescription>
</CardHeader>
<CardContent>
<AuditLedgerExplorer columns={["Mule Accounts","Suspicious Transactions","AML Alerts","Customer Risk Profiles"]} />
</CardContent>
</Card>
</div>
