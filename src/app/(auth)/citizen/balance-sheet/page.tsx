      ...
      <div className="max-w-7xl mx-auto p-6 relative z-10 space-y-6">
        ...
        <header className="flex flex-col md:flex-row md:items-end justify-between gap-4 border-b border-cyan-900/40 pb-6">
          <div>
            ...
            <h1 className="text-3xl font-black text-white tracking-tight">Balance Sheet</h1>
            <p className="text-sm text-emerald-400 mt-2 font-mono flex items-center gap-2">
              <AlertCircle className="h-4 w-4" /> 
              KEY QUESTION: "Track wealth creation"
            </p>
          </div>
        </header>
...
<CardHeader>
<CardTitle className="text-white">Balance Sheet Records</CardTitle>
<CardDescription className="text-slate-400">Tracking: Assets, Liabilities, Net Worth Trend, Asset Allocation, Debt Breakdown, Wealth Forecast</CardDescription>
</CardHeader>
<CardContent>
<AuditLedgerExplorer columns={["Assets","Liabilities","Net Worth Trend","Asset Allocation","Debt Breakdown","Wealth Forecast"]} />
</CardContent>
</Card>
</div>
