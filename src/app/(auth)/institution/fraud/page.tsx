...
<CardDescription className="text-slate-400">Tracking: Application fraud, Identity fraud, Transaction fraud</CardDescription>
</CardHeader>
<CardContent>
<AuditLedgerExplorer columns={["Application fraud","Identity fraud","Transaction fraud"]} />
</CardContent>
</Card>
</div>
