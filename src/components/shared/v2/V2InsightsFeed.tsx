...
import { Zap, AlertTriangle, ShieldCheck, LucideIcon } from "lucide-react";
...
export interface V2InsightsFeedProps {
  title: string;
  items?: InsightItem[];
}

export function V2InsightsFeed({ title, items }: V2InsightsFeedProps) {
  const defaultItems = [
