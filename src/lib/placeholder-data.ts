...
export const subsidyDetailsData = [
  {
    ...
    amount: '2,03,420',
    description:
      'Implemented mainly through the National Food Security Act (NFSA), covering distribution of rice, wheat, and coarse grains to ~81 crore beneficiaries.',
    icon: Utensils,
  ...
  },
  {
    ...
    amount: '1,67,887',
    description:
      'Covers both Urea subsidy and Nutrient-Based Subsidy (NBS) for phosphatic & potassic fertilisers, ensuring farmers get fertilisers at affordable prices.',
    icon: Wheat,
  ...
  },
  {
    ...
    amount: '12,100',
    description:
      'Includes LPG subsidy under the PAHAL Direct Benefit Transfer (DBT) scheme, providing subsidised cooking gas for low-income households.',
    icon: Fuel,
  ...
  },
  {
    ...
    amount: '27,840',
    description:
      'Support for sectors like education loans, MSMEs, export promotion, and housing through schemes like the Interest Subvention Scheme (ISS).',
    icon: Banknote,
  ...
  },
  {
    ...
    amount: '14,969',
    description:
      'Includes Price Support Scheme (PSS), Market Intervention Scheme (MIS), and subsidies for jute, sugar, and other industrial incentives.',
    icon: Landmark,
...
export const governmentBalanceSheetDataProjected = {
  ...
  liabilities: [
    {
      name: 'On Revenue Account',
      value: 4000000,
      subItems: [{ name: 'Interest Payments', value: 1200000 }],
    },
    {
      name: 'On Capital Account',
      value: 1400000,
      subItems: [
...
export const governmentBalanceSheetDataFy2526 = {
  ...
  liabilities: [
    ...
    { name: 'On Capital Account', value: 1121090, subItems: [] },
  ],
};
...
export const schemes = [
  {
    ...
    description:
      '₹736 crore has been allocated for affordable housing in Uttar Pradesh under the Pradhan Mantri Awas Yojana.',
  },
  {
    icon: ShieldCheck,
    title: '₹20,000 Crore Infrastructure Guarantee Fund',
    description:
      'The government is establishing a ₹20,000 crore fund to support infrastructure investments by covering non-commercial risks.',
  },
  {
    icon: Bot,
    title: 'SUMAN SAKHI Chatbot',
    description:
      'Madhya Pradesh is launching an AI-based chatbot, providing 24/7 maternal and reproductive health information to women via WhatsApp.',
  },
  {
    icon: Factory,
    title: 'Kalamkari Garment Cluster',
    description:
      'Maharashtra is developing a Kalamkari garment cluster to train rural women in traditional garment-making, promoting self-employment.',
  },
  {
    icon: Wheat,
    title: 'Prime Minister Dhan-Dhaanya Krishi Yojana',
    description:
      'This scheme aims to support 1.7 crore farmers in 100 districts with low agricultural productivity through targeted measures.',
  },
  {
    icon: Rocket,
    title: 'Digital Agriculture Mission (DAM)',
    description:
      'The government is promoting the use of digital tools and technologies to enhance agricultural sustainability and productivity.',
  },
  {
    icon: UserRound,
    title: 'UIDAI Biometric Update',
    description:
      'Biometric updates for children aged 0-5 and 15-17 are being conducted to ensure accurate records for accessing educational and welfare services.',
  },
  {
    icon: GraduationCap,
    title: 'PM Internship Scheme',
    description:
      'The scheme offers 12-month internships in top companies across various sectors, aiming to provide 1 crore internships over the next five years.',
  },
  {
    icon: Leaf,
    title: 'Carbon Capture Incentives',
    description:
      'Financial support will be provided for carbon capture projects, aiming to reduce emissions while maintaining coal as a key energy source.',
  },
  {
    icon: Magnet,
    title: 'Rare Earth Magnet Manufacturing',
    description:
      'Fiscal incentives will be offered to encourage the local production of rare-earth magnets, which are essential for electric vehicles and renewable energy sectors.',
  },
];
...
export const dummyFtidData = JSON.stringify(
  [
    ...
    },
    {
      ...
      location: { latitude: 19.0765, longitude: 72.878 },
    },
    {
      ...
      location: { latitude: 19.078, longitude: 72.88 },
    },
  ],
  null,
  2
...
export const economicIndicatorsData = [
  ...
  {
    label: 'Current Account Deficit (CAD)',
    value: '1.5% of GDP',
    change: 'Current Account Deficit',
    icon: ArrowRightLeft,
  },
  {
